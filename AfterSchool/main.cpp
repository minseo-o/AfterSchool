...
const int GO_WIDTH = 700, GO_HEIGHT = 300;	// 게임오버 그림의 크기
...
int main(void)
{
	...
	player.sprite.setPosition(210, 120);
	...
	enemy_explosion_sound.setBuffer(sb.gun);
	int enemy_score = 100;
	...
	while (window.isOpen())
	{
		...
		sprintf(info, "geumbungeoui eomma chajgi daejagjeon life:%d score:%d time:%d"
